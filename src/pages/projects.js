...
const projects = () => {
    return(
        <div className="w-screen flex flex-col items-center min-h-screen bg-backgroundGrey">
           ...
           <h2 className="font-display text-center text-4xl m-3 blue-underline">Projects</h2>
           <ul>
                <li>
                    <h3 className="font-display text-center mt-4 text-xl">This Website</h3>
                ...
                <li>
                    <h3 className="font-display text-center text-xl mt-4">Magenta Rejects</h3>
                ...
                <li>
                    <h3 className="font-display text-center text-xl mt-4">Project Wayfarer</h3>
                ...
                <li>
                    <h3 className="font-display text-center text-xl mt-4">Tables</h3>
                    <p className="font-body italic text-center">Bootcamp Project</p>
                    <p className="font-body text-center">https://example.com</p>
                ...
                <li>
                    <h3 className="font-display text-center text-xl mt-3">Alex and Tom's Art Blog</h3>
                    <p className="font-body italic text-center">Bootcamp Project</p>
                    <p className="font-body text-center">https://example.com</p>
