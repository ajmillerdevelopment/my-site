  ...
  return (
    <div className="w-screen flex flex-col items-center min-h-screen bg-backgroundGrey">
      ...
      <nav className="m-1 flex flex-col">
        <a href="/about" className="m-4 font-display underline text-center text-2xl">About Me</a>
        <a href="/resume" className="m-4 font-display underline text-center text-2xl">Resume</a>
        <a href="/projects" className="m-4 font-display underline text-center text-2xl">Projects</a>
      </nav>
    </div>
  )
}
